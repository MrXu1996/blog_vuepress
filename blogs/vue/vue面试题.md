...
当一个Vue实例创建时，vue会遍历data选项的属性，用 Object.defineProperty（vue3.0使用proxy ）将它们转为 getter/setter 并且在内部追踪相关依赖，在属性被访问和修改时通知变化。 每个组件实例都有相应的 watcher程序实例，它会在组件渲染的过程中把属性记录为依赖，之后当依赖项的setter被调用时，会通知watcher重新计算，从而致使它关联的组件得以更新。 ![1ea415955f753356abe09214d31cac89.jpg](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/eca9d99af4a749f485360bdb460a16e0~tplv-k3u1fbpfcp-zoom-1.image)
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c6ddddb2d42b45ba821168603d555470~tplv-k3u1fbpfcp-zoom-1.image)
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e02c8c1465e046a78d7690d8c1ccf0ac~tplv-k3u1fbpfcp-zoom-1.image)
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7524c7357fc543aba98b0731bfa4a176~tplv-k3u1fbpfcp-zoom-1.image)那Vue是如何实现让这些数组方法实现元素的实时更新的呢，下面是Vue中对这些方法的封装：
...
**区别：** ![775316ebb4c727f7c8771cc2c06e06dd.jpg](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/783d6be21d414d31af1cbc3cf2254f58~tplv-k3u1fbpfcp-zoom-1.image)
...
![bb253b1d177f421741af0e7dd0f52b5e.jpg](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c8012ae1591345f7a8b8da3254b72005~tplv-k3u1fbpfcp-zoom-1.image)（2）mergeOptions 的执行过程**
...
![b025e120ca3d0bd2ded3d038d58cacf4.jpg](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/03320f926f804239858a7654a40c6c71~tplv-k3u1fbpfcp-zoom-1.image) Vuex为Vue Components建立起了一个完整的生态圈，包括开发中的API调用一环。
